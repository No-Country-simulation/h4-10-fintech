...
const allInvestments: Investment[] = [
  {
    id: 1,
    name: "Fondo de Inversión A",
    risk: "Bajo",
    return: "5-7%",
    trending: true,
    description: "Fondo diversificado de renta fija",
  },
  {
    id: 2,
    ...
    return: "10-15%",
    trending: false,
    description: "Cartera de acciones de empresas tech",
  },
  {
    id: 3,
    ...
    return: "7-9%",
    trending: true,
    description: "Bonos de empresas líderes",
  },
  {
    id: 4,
    name: "ETF S&P 500",
    ...
    return: "8-12%",
    trending: true,
    description: "Fondo que sigue al índice S&P 500",
  },
  {
    id: 5,
    ...
    return: "4-6%",
    trending: false,
    description: "Inversión en propiedades comerciales",
  },
];
      ...
      <CardContent>
        <div className="space-y-4">
          {investments.map((investment) => (
            <div
              key={investment.id}
              className="flex flex-col space-y-2 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg"
            >
              ...
              <p className="text-sm font-medium">
                Retorno esperado: {investment.return}
              </p>
        ...
        <div className="mt-4 p-4 bg-blue-100 dark:bg-blue-900 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300">
              Estas recomendaciones están basadas en tu perfil de riesgo y
