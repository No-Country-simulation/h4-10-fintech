                    ...
                    <form className="mt-6" onSubmit={handleSubmit}>
                        <div className="relative w-full mb-5">
                            ...
                            <input
                                ...
                                className={`w-full border ${errors.email ? 'border-red-500' : 'border-[#79747E]'} rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                            />
                        ...
                        <div className="relative w-full mb-6">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    className={`w-full border ${errors.password ? 'border-red-500' : 'border-[#79747E]'} rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                                />
                                <span
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center justify-center">
                                ...
                                <label htmlFor="remember" className="text-gray-700 text-sm">Recordarme</label>
                            </div>
