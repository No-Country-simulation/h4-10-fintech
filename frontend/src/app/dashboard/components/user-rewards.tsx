...
const rewardsData: Reward[] = [
    { id: 1, name: "Ahorrador Novato", description: "Ahorra tu primer $1000", icon: Trophy, progress: 75 },
    { id: 2, name: "Inversor Prudente", description: "Realiza 5 inversiones", icon: Star, progress: 40 },
    { id: 3, name: "Maestro Financiero", description: "Completa todos los módulos educativos", icon: Award, progress: 20 },
]
