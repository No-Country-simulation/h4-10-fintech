...
import { Home, PieChart, Target, DollarSign, FileText, Users, Settings, LogOut } from 'lucide-react'
import { cn } from "@/lib/utils"
import { UserPoints } from "@/app/dashboard/components/user-points"
...
const menuItems = [
    ...
    { icon: FileText, label: 'Radiografía Financiera', href: '/dashboard/radiografia' },
    ...
    return (
        <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
            <div className="h-full flex flex-col">
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 p-4">
                    <p className="text-sm text-gray-500 dark:text-gray-400">© 2023 Iupi Finanzas</p>
                </div>
            </div>
        </aside>
    )
