...
public class TiempoController {
    ...
    public ResponseEntity<ApiResponseDto<TiempoDto>> getTiempoById(@PathVariable Long id) {
        Optional<TiempoDto> tiempo = tiempoService.findById(id);
    ...
    public ResponseEntity<ApiResponseDto<TiempoDto>> getAllTiempos() {
        Iterable<TiempoDto> tiempos = tiempoService.findAll();
    ...
    public ResponseEntity<ApiResponseDto<TiempoDto>> createTiempo(@Valid @RequestBody TiempoRequestDto tiempoRequestDto) {
        TiempoDto tiempoCreado = tiempoService.save(tiempoRequestDto);
    ...
    public ResponseEntity<ApiResponseDto<TiempoDto>> updateTiempo(@PathVariable Long id, @Valid @RequestBody TiempoRequestDto tiempoRequestDto) {
        TiempoDto tiempoActualizado = tiempoService.update(id, tiempoRequestDto);
